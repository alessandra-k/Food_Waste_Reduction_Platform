...
public class Retailer_InventoryManagement_Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "surplus" -> request.getRequestDispatcher("/Views/SurplusItems_Management.jsp").forward(request, response);
            case "RetailerHome" -> request.getRequestDispatcher("/Views/retailerPage.jsp").forward(request, response);
            case "Inventory" -> request.getRequestDispatcher("/Views/retailer_InventoryManagement.jsp").forward(request, response);
            default -> {
            }
        }
    }
